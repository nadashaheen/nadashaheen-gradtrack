<div class="sidebar card-authntucation-color p-20 p-relative">
    ...
    <ul lass="d-flex flex-column ">
        <li>
            <a class="sidebar-link active d-flex align-items-center fs-16 primary-color p-10" href="{{route('dashboardStd')}}"
        ...
        <li>
            <a class="sidebar-link d-flex align-items-center fs-16 primary-color p-10" href="{{route('show_add_final')}}" data-page="finalproject">
        ...
        <li class="mt-auto logout">
            <a href="{{route('logout')}}" class="sidebar-link d-flex align-items-center fs-16 p-10"
